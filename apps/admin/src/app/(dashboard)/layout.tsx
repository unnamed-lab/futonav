  ...
  return (
    <div className="flex min-h-screen bg-[#f8fafc] text-[#0f172a] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-25%] left-[-20%] w-[60%] h-[60%] bg-indigo-500/5 rounded-full blur-[150px] animate-pulse-slow" />
        <div className="absolute bottom-[-25%] right-[-20%] w-[60%] h-[60%] bg-teal-500/5 rounded-full blur-[150px] animate-pulse-slow" />
      </div>
